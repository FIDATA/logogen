...
class FreeDesktopGenerator extends Generator {
  ...
  @Override
  Class<? extends AbstractConverter> getConverterImplClass() { Converter }
  ...
  @CompileStatic
  static final class Converter extends Generator.AbstractConverter {
    ...
    protected final static class ImageMagickConvertOperation extends Generator.AbstractConverter.ImageMagickConvertOperation {
