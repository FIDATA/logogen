...
*/
@CompileStatic
final class WindowsTiles extends Generator.AbstractConverter {
  public static final LogoGeneratorDescriptor DESCRIPTOR = new LogoGeneratorDescriptor('windowsTiles', WindowsTiles, 'windowsRT')

  static final class imageMagickConvertOperation extends Generator.AbstractConverter.ImageMagickConvertOperation {
  ...
  static final class GenerateXmlOperation extends Generator.AbstractConverter.GenerateXmlOperation {
    @Inject
  ...
  protected final void generate() {
    workerExecutor.submit(imageMagickConvertOperation, new Action<WorkerConfiguration>() {
      @Override
